...
def read_uvigo(basedir, casename):
    ...
    return xr.Dataset(
       {
       "WaterSip-FLEXPART (LATTIN, UVigo)": xr.open_dataarray(path / "ERA5_APA22_reg.nc"),
       "Stohl&James-FLEXPART": xr.open_dataarray(path / "ERA5_SJ05_reg.nc"),
        }
     )
...
def read_utrack(basedir, casename):
    ...
    ensemble_members = {
        ...
        "UTrack": path.glob("*_mixing24h_dt025h_100p.nc"),
...
def read_ughent(basedir, casename):
    ...
    ensemble_members = {
        ...
        "HAMSTER-FLEXPART": "ens5_rhadap80",
    }
...
def read_flexpart_tatfancheng(basedir, casename):
    ...
    for member in ensemble_members:
        ...
        ensemble[f"FLEXPART-Watersip (HKUST)"] = ds.sortby(ds.lon)["Cb"]
...
def read_flexpart_xu(basedir, casename):
    ...
    return (
        ...
        .sum("time")
        .rename("WaterSip-FLEXPART (IBCAS)")
    )
...
def read_flexpart_univie(basedir, casename):
    ...
    return combined.rename("WaterSip-FLEXPART (UniVie)")
...
def read_flexpart_uib(basedir, casename):
    ...
    ds_flexpart_uib = xr.open_dataset(path / filename)["moisture_uptakes"].rename("WaterSip-FLEXPART (UiB)")
...
#NOTE: This is a version of the combine_data.py script that only reads the specific members of models and uses the updated naming convention.